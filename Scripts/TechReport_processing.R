...
# REQUEST 2: MAP OF TRAWL CLOSURE AREAS W/CPS1 SURVEY AREA --------------------------------------------------------------------------------
 ...
 ggplot() +
   ...
   geom_sf(data = st_as_sf(BB_strata), fill = NA, aes(color = "black"), linewidth = 0.5) +
   ...
   geom_sf_pattern(data = st_as_sf(zone1$Shape),
                   pattern_type = "stripe", fill = NA, color = "black", pattern_alpha = 0.15)+
   ...
   geom_sf_pattern(data = st_as_sf(nbbtca$Shape),
                   pattern_type = "stripe", fill = NA, color = "black", pattern_alpha = 0.15, pattern_angle = 120)+
   geom_sf(data = st_as_sf(CPS1_bound), fill = NA, aes(color = "olivedrab2"), linewidth = 1.5)+
